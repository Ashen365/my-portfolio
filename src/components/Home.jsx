  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 text-center">
        <div className="mb-2 inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 rounded-full backdrop-blur-sm">
        ...
        <div className="h-8 sm:h-10 mb-6 sm:mb-8">
          <p
            ref={titleRef}
            className="text-base sm:text-xl md:text-2xl lg:text-3xl text-slate-200 font-medium inline-flex items-center flex-wrap justify-center"
          >
            <span className="mr-2">I'm a</span>
            <span className="text-green-400"></span>
            <span className="typing-cursor ml-1 inline-block w-0.5 h-5 sm:h-6 md:h-8 bg-green-400 animate-blink"></span>
          </p>
        </div>

        <div
          ref={cardRef}
          className="mb-8 sm:mb-10 backdrop-blur-lg bg-white/5 border border-white/10 p-1 rounded-xl sm:rounded-2xl shadow-[0_0_40px_rgba(8,_112,_184,_0.1)]"
        >
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10">
            {[
              ...
              <div key={index} className="p-3 sm:p-4 md:p-6 flex flex-col items-center justify-center gap-2 sm:gap-3 hover:bg-white/5 transition-colors duration-300">
                <div className={`${item.color} p-2 sm:p-3 rounded-lg sm:rounded-xl bg-white/5`}>
                  {item.icon}
                </div>
                <span className="font-medium text-slate-200 text-sm sm:text-base">{item.title}</span>
              </div>
            ))}
          </div>
        </div>

        <div ref={btnRef} className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
          <a
          ...
          >
            <span className="relative z-10 flex items-center text-sm sm:text-base">
              View My Work
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-2 w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-300 group-hover:translate-x-1">
        ...
        {/* Social icons */}
        <div className="mt-8 sm:mt-10 md:mt-12 flex items-center justify-center gap-3 sm:gap-4 px-4">
          {[
            {
              href: "https://github.com/Ashen365",
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="sm:w-5 sm:h-5">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="p-2 sm:p-2.5 rounded-full text-slate-400 hover:text-white hover:bg-white/10 transition-colors duration-300"
        ...
        <div className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
          <span className="text-xs text-slate-400 mb-1 sm:mb-2 animate-bounce">Scroll Down</span>
