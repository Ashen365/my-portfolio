...
const projects = [
  ...
  {
    title: 'TodoApp',
    technology: 'React Native, Mobile Development',
    description: 'A feature-rich mobile task management application with intuitive UI, task categorization, reminders, and offline support. Built with React Native for seamless cross-platform experience.',
